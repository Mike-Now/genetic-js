var Genetic = Genetic || (function() {
    ...
    function Genetic() {
        ...
        this.start = function() {
            ...
            // seed the population
            for (i = 0; i < self.configuration.size; ++i) {
                self.entities.push(Clone(self.seed()));
            }


            function iter(ii) {
                if (ii >= self.configuration.iterations || isFinished) {
                    return;
                }
                ...
                // score and sort
                //
                Q.all(self.entities.map(function(entity) {
                    return self.fitness(entity);
                })).then(function(fitVals) {
                    var pop = fitVals.map(function(val, idx, arr) {
                        return {
                    ...
                    cb(pop,ii);
                    setImmediate(function(){iter(ii + 1)});
                });
            ...
            function cb(pop,i) {
                ...
                isFinished = (typeof r != "undefined" && !r) || (i == self.configuration.iterations - 1);

                if (
                    self.notification && (isFinished || self.configuration["skip"] == 0 || i % self.configuration["skip"] == 0)
                ) {
    ...
    Genetic.prototype.evolve = function(config, userData) {
        ...
        this.usingWebWorker = this.configuration.webWorkers && typeof Blob != "undefined" && typeof Worker != "undefined" && typeof window.URL != "undefined" && typeof window.URL.createObjectURL != "undefined";
